...
describe('common functions', () => {
    describe('parseAbbr', () => {
        ...
        describe('given: there is a class expession ', () => {
            let exp;
        ...
        describe('given: there is an id expession ', () => {
            let exp;
        ...
        describe('given: there is a type expession ', () => {
            let exp;
        ...
        describe('given: there is an attr expession ', () => {
            let exp;
